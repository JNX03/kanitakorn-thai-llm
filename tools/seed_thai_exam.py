...
SEEDS: list[dict] = [
    ...
    _exam(
        ...
        "พ.ศ. 1781",
        ["พ.ศ. 1781", "1781", "พุทธศักราช 1781", "ประมาณ พ.ศ. 1781"],
        task_type="thai_history",
        difficulty="medium",
        explanation="อาณาจักรสุโขทัยก่อตั้งขึ้นประมาณ พ.ศ. 1781 (ค.ศ. 1238) โดยพ่อขุนศรีอินทราทิตย์ทรงรวบรวมกำลังขับไล่ขอมออกจากเมืองสุโขทัย",
    ...
    # --- Thai social studies ---
    _exam(
        "รัฐธรรมนูญไทยกำหนดให้รัฐต้องอุปถัมภ์และคุ้มครองศาสนาใดเป็นพิเศษ",
        "พระพุทธศาสนา",
        ["พระพุทธศาสนา", "ศาสนาพุทธ", "พุทธศาสนา", "พุทธ", "Buddhism"],
        task_type="thai_social_studies",
        difficulty="medium",
        explanation="รัฐธรรมนูญแห่งราชอาณาจักรไทยไม่ได้ระบุศาสนาประจำชาติอย่างเป็นทางการ แต่กำหนดให้รัฐต้องอุปถัมภ์และคุ้มครองพระพุทธศาสนาซึ่งเป็นศาสนาที่ประชากรส่วนใหญ่นับถือ (ราว 93%) เป็นพิเศษ",
        sources=[_enwp("Buddhism_in_Thailand"), _enwp("Religion_in_Thailand")],
    ),
    _exam(
